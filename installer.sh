...
echo -b "AUTHOR    : RaElya_Cyber $green " |lolcat
...
sleep 1
echo -b $green"[#]> RaElya_Cyber On Your System" |lolcat
...
00) echo "AUTHOR: RaElya_Cyber" | lolcat
echo "RaElya_Cyber ON YOUR SYSTEM" | lolcat
